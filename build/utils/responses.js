export function returnInteractionResponse(content) {
...
export function returnErrorReadingPasswordFile(content) {
    return `❌ Error reading password file: ${content}

Please check your JSON file format and try again.`;
}
export function returnErrorMissingInfo(content, args) {
    if (!args)
        return content;
...
export function returnWalletCreatedSuccessfully(content, args) {
    if (!args)
        return content;
...
export function returnErrorTryAgain(content, args) {
    if (!args)
        return content;
...
export function returnToCheckBalance(content, args) {
    if (!args)
        return content;
...
export function returnErrorInvalidWalletData(content) {
...
export function returnCheckBalanceSuccess(content, data = null) {
    if (!data)
        return content;
...
export function returnErrorCheckingBalance(content) {
...
export function returnErrorTXHashInvalid(content) {
...
export function returnTransactionFound(content, data = null) {
    if (!data)
        return content;
...
export function returnErrorTxNotFound(content, args) {
    if (!args)
        return content;
...
export function returnErrorCheckingTransaction(content) {
